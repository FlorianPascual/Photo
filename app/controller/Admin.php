...
use rave\lib\core\security\File;
...
class Admin extends Controller
{
    ...
    public function addPhoto()
    {
        ...
        if (In::isSetPost('title', 'subtitle', 'description', 'tags')) {
            ...
            try {
                $image = ImageManagerStatic::make(ROOT . '/public/img/photo/' . $fileName);
                $image->widen(545)->save(ROOT . '/public/img/photo/gallery/' . $fileName);
            } catch (Exception $exception) {
                Error::create($exception->getMessage(), 500);
            }
